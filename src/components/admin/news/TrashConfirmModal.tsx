      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-100 dark:border-slate-800 bg-red-50/50 dark:bg-red-950/20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-slate-900 dark:text-white text-sm">Move Article to Trash</h3>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          {isPublished && (
            <div className="p-3 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-xl text-xs text-amber-800 dark:text-amber-300 flex items-start gap-2">
              ...
              <span>
                <strong>Warning:</strong> This article is currently <strong>Published</strong>. Moving it to trash will immediately remove it from all public views on the website.
              </span>
            </div>
          )}

          <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            Are you sure you want to move <strong>"{articleTitle}"</strong> to trash? You can restore it later if needed.
          </p>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="e.g. Outdated information, duplicate article, or user request..."
              rows={3}
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-4 py-2 text-xs font-bold rounded-xl bg-red-600 hover:bg-red-700 text-white transition-colors shadow-sm disabled:opacity-50"
            >
