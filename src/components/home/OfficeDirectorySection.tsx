    ...
    <section className="relative bg-white dark:bg-[#0B1912] py-16 lg:py-24 border-b border-[#DDE8E1] dark:border-emerald-900/60 transition-colors duration-200">
      ...
      {selectedOffice && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
          <div className="w-full max-w-lg rounded-2xl bg-white dark:bg-[#0B1912] p-6 sm:p-7 shadow-2xl border border-[#DDE8E1] dark:border-emerald-900/60">
            <div className="flex items-start justify-between border-b border-[#DDE8E1] dark:border-emerald-900/60 pb-4">
            ...
            <div className="mt-5 space-y-4 text-xs sm:text-sm">
              <h4 className="text-lg font-bold text-[#063D2A] dark:text-emerald-200">{selectedOffice.nameKey}</h4>
              <p className="text-[#637069] dark:text-emerald-300/80">Zonal Bureau Director: <strong className="text-[#14251D] dark:text-emerald-100">{selectedOffice.headName}</strong></p>

              <div className="rounded-xl bg-[#EFF8F2] dark:bg-[#183627] p-4 space-y-3 border border-[#DDE8E1] dark:border-emerald-800/60">
                <div className="flex items-center gap-3 text-[#14251D] dark:text-emerald-100 font-semibold">
                  <MapPin className="h-4 w-4 text-[#087A4B] dark:text-[#D7A928] shrink-0" />
                  <span>{selectedOffice.address}</span>
                </div>
                <div className="flex items-center gap-3 text-[#14251D] dark:text-emerald-100 font-bold">
                  <Phone className="h-4 w-4 text-[#087A4B] dark:text-[#D7A928] shrink-0" />
                ...
                <div className="flex items-center gap-3 text-[#14251D] dark:text-emerald-100 font-medium">
                  <Clock className="h-4 w-4 text-[#087A4B] dark:text-[#D7A928] shrink-0" />
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="rounded-xl bg-[#063D2A] dark:bg-emerald-800 px-5 py-2.5 text-xs font-bold text-white hover:bg-[#087A4B] transition-colors"
              >
                {t('close')}
              </button>
            </div>
