    ...
    <section className="relative bg-gradient-to-b from-[#EFF8F2] via-white to-[#EFF8F2] dark:from-[#0B1912] dark:via-[#0E2218] dark:to-[#0B1912] py-16 lg:py-24 border-b border-[#DDE8E1] dark:border-emerald-900/60 transition-colors duration-200">
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          ...
          <div className="flex items-center gap-2 text-xs font-bold text-[#637069] dark:text-emerald-300/80 bg-white dark:bg-[#12281D] px-4 py-2.5 rounded-2xl border border-[#DDE8E1] dark:border-emerald-800/60 shadow-xs shrink-0 self-start md:self-auto">
