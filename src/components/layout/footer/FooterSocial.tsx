...
export const FooterSocial: React.FC = () => {
  ...
  return (
    <div className="space-y-3">
      <span className="text-xs sm:text-sm font-extrabold uppercase tracking-wider text-[#063D29] dark:text-[#74d62c] block">
        {t('footer_follow_us')}
      </span>
